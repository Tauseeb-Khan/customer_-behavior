...
-- q3- which are the top 5 product whith the highest average review rating ?
select item_purchased, round(AVG(review_rating),2) as "Average Product Rating"
from customer
group by item_purchased
order by avg(review_rating) desc
limit 5;
-- q4- compare the average purcahse amount between standard and express shipping. 
...
-- q7- segment customer into new , returning, and loyal based on their total  number of previous purchased , and show the count of each segment 
...
-- q9. are customer who are repeat buyers (more than 5 previous purchased) also likely to subscribe?
